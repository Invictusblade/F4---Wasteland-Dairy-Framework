Scriptname INVB_Overlay_Instant_Global extends ObjectReference
...
GlobalVariable property INVB_Global_PH Auto Mandatory
...
Event OnEquipped(Actor akActor)
	...
	if (random_LList <= INVB_Global_PH.GetValue())
		Utility.Wait(random_time)
		AddMyOverlays(akActor)
	elseif (random_LList > INVB_Global_PH.GetValue())	
		Utility.Wait(random_time)
		akActor.unequipitem(pArmor_Overlay)
		Utility.Wait(random_time)
