ScriptName INVB_Cuminject extends ObjectReference
...
SPELL Property SP_SemenOverlay Auto
...
Event OnEquipped(Actor akActor)
	...
	if int_start == 1
		...
		if INVB_Global_Overlay_Boolean.GetValue() == 1
			SP_SemenOverlay.Cast(akActor, akActor)
		endIf	
		
	endIf
	akActor.unequipitem(pArmor_Cuminjector,true,false)
	akActor.removeitem(pArmor_Cuminjector,1, true)
EndEvent
